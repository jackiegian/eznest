                ...
                onGenerateRoute: (settings) {
                  switch (settings.name) {
                    ...
                    case '/home':
                      ...
                      final argsLogin = settings.arguments as Account;
                      return MaterialPageRoute(
                        builder: (context) => MainScreen(loginAccount: argsLogin),);
                    case '/login':
                      return MaterialPageRoute(
                    ...
                    case '/signup_image':
                      final argsSignup = settings.arguments as Account;
                      return MaterialPageRoute(
                          builder: (context) => SignUpImageScreen(signupAccount: argsSignup));
                    default:
                      return null;
                  }
                });
